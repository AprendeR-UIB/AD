...
La identificación de tendencias, patrones cíclicos y comportamientos estacionales en series temporales proporciona valiosa información para construir modelos predictivos que ayuden en la toma de decisiones, la planificación estratégica y la anticipación de eventos futuros [véase @cryer] y [véase @pena].
...
![](Figuras/proceso_estocastico.png){width=90% fig-align="center" .lightbox}
...
![](Figuras/proceso_estocastico2.png){width=60% fig-align="center" .lightbox}
...
![](Figuras/SinTendencia.png){.lightbox group="tendencias"}
...
![](Figuras/Heterocedastico.png){.lightbox group="tendencias"}

Una serie puede tener tendencia y ser heterocedástica

![](Figuras/TendenciaHeterocedastico.png){.lightbox group="tendencias"}
...
![](Figuras/conductas_st.png){width=100% .lightbox}
...
#|   group: reto
set.seed(24042024)
simulación <- arima.sim(list(order = c(2,0,0), ar = c(0.7, -0.5)), n = 200)
par(mfrow=c(3,1))
plot(1:200,simulación,type="l",xlab="")
acf(simulación)
pacf(simulación)
```
