...
2. El proyecto debe incluir:
    ...
    * El peso de la evaluación es el siguiente: 0.8* Nota de la Expo + 0.2* Nota del repositorio. Para calcular la nota de la Expo (exposición), se tomará la calificación media de vuestros compañeros (excluidos los integrantes del grupo) y la asignada por los profesores. Si la diferencia de notas entre los profesores y los compañeros es mayor a 2 puntos, contará únicamente la nota de los profesores.
