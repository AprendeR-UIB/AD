...
knitr::include_graphics("Figuras/combinar_tablas.PNG") 
```
...
```{r, echo=F, out.height='60%', out.width='70%', fig.align='center'}
knitr::include_graphics("Figuras/stats.PNG")
```
...
```{r, echo=F, out.height='50%', out.width='40%', fig.align='center'}
knitr::include_graphics("Figuras/facetas.PNG")
```
...
```{r, echo=F, out.height='50%', out.width='40%', fig.align='center'}
knitr::include_graphics("Figuras/posicion.PNG")
```
...
### Ejemplo integrando las herramientas de tidyverse 
...
knitr::include_graphics("Figuras/violin.PNG")
```
