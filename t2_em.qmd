...
1)  $f(x_1,\ldots,x_p)\ge0$, para todo
    $(x_1,\ldots,x_p)\in\mathbb{R}^p$.
2)  $\int_{\mathbb{R}^p}f(x_1,\ldots,x_p)dx_1\cdots dx_p=1.$
...
![](Figuras/correlacion_espuria.png){width="80%" fig-align="center"}
...
![](Figuras/tabla_binaria.png){width="80%" fig-align="center"}
...
![](Figuras/tabla_futbol.png){width="80%" fig-align="center"}
